...
def main(args):
    ...
    print(np.mean(a * colmap_depths), np.max(a * colmap_depths), np.min(a * colmap_depths),
          np.median(gt_depths) / np.median(colmap_depths))
...
if __name__ == '__main__':
    ...
    #     elif args.scene == 'scene_7':
    #         i_val = [23, 77, 165, 290, 314]
    #     elif args.scene == 'scene_9':
    #         i_val = [38, 57, 147, 312, 101]
    #     elif args.scene == 'scene_11':
